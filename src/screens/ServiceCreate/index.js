...
const CreateService = ({navigation}) => {
    ...
    if (isJobCreate) {
      ...
      if (step === 2) {
        if (
          ...
          selectedDays[0]?.openingTime == null ||
          selectedDays[0]?.closingTime == null
        ) {
          Toast.show({
            type: 'error',
            text1: t('Pleaseselectrates'),
  ...
  return hourlyRates === 0 || hourlyRates === '' || hourlyRates === '0' ? (
    ...
    <View style={styles.container}>
      ...
      <InformationPopup
        modalVisible={informationPopup}
        setModalVisible={() => setinformationPopup(false)}
        info={1}
      />
      <InformationPopup
        modalVisible={informationPopup1}
        setModalVisible={() => setinformationPopup1(false)}
        info={2}
      />
      ...
      {step === 0 && (
        <ScrollView
          ...
          <View style={{width: '90%'}}>
              ...
              <>
                <View style={styles.heading}>
                  <TouchableOpacity
                    ...
                    <Text
                      style={[Typography.text_paragraph_1, styles.headingText]}>
                      {t('howmanyhoursdoyou')}
                    </Text>
                    <FontAwesome5
                      name="info-circle"
                ...
                <ScrollView
                  ...
                  <HorizontalList
                    selectedState={selectedHour}
                    setselectedState={setselectedHour}
                    title={'1'}
                  />
                  <HorizontalList
                    selectedState={selectedHour}
                ...
                <ScrollView
                  ...
                  style={styles.horizontalScroll}>
                  <HorizontalList
                    selectedState={selectedProfessional}
                    setselectedState={setselectedProfessional}
                    title={'1'}
                  />
                  <HorizontalList
                    selectedState={selectedProfessional}
            ...
            <View style={[styles.heading, {marginTop: 30}]}>
              <Text style={[Typography.text_paragraph_1, styles.headingText]}>
                {t('selectCategory')}
              </Text>
              {isError && selectedCategories == '' && (
                <Text style={{top: 3, color: colors.Error_Red}}>*</Text>
              )}
            </View>
                ...
                <View style={styles.listDropDown}>
                  <Select
                    ...
                    onValueChange={itemValue =>
                      setselectedsubcategories(itemValue)
                    }>
              ...
              <>
                ...
                <View style={styles.listDropDown}>
                  <Select
                    ...
                    color={colors.Neutral_01}
                    mt={1}
                    onValueChange={itemValue => roomSizeHandler(itemValue)}>
                    {roomSizes.length &&
                      roomSizes.map((key, index) => (
                        <Select.Item
                          key={index}
                          label={key.title}
                          value={key.title}
              ...
              <>
                ...
                <View style={styles.listDropDown}>
                  <Select
                    ...
                    color={colors.Neutral_01}
                    mt={1}
                    onValueChange={itemValue => roomQtyHandler(itemValue)}>
                    {noOfRooms.length &&
                      noOfRooms.map((key, index) => (
                        <Select.Item
                          key={index}
                          label={key.title}
                          value={key.title}
            ...
            {isJobCreate && selectedCategories === CleaningAndHygineService && (
              <>
                ...
                <View
                  ...
                  <BookingStatusTab
                    selectedState={needCleaningMaterials}
                    setselectedState={e => cleaningMaterialHandler(e)}
                    title={t('noIhavethem')}
                  />
                  <BookingStatusTab
                    selectedState={needCleaningMaterials}
        ...
        <ScrollView
            ...
            <View style={{width: '90%'}}>
              ...
              <View style={styles.listDropDown}>
                <Select
                  ...
                  color={colors.Neutral_01}
                  mt={1}
                  onValueChange={itemValue => settotalPrice(itemValue)}>
                  {fixRates.length &&
                    fixRates.map((key, index) => (
                      <Select.Item
                        key={index}
                        label={key.rate + ' Euro'}
                        value={key.rate}
          ...
          <View
            ...
            <TouchableOpacity
              ...
              {isError && productImages[0].imagURL === '' && (
                <Text style={{top: 3, color: colors.Error_Red}}>*</Text>
              )}
            </TouchableOpacity>
            <TouchableOpacity
            ...
            <View style={{width: '90%'}}>
              ...
              <View style={{width: '100%', marginTop: 10}}>
                <View style={{flexDirection: 'row'}}>
                  <Text
                    style={[styles.fieldHeading, {color: colors.Neutral_01}]}>
                    {t('selectDate')}
                  </Text>
                  {isError && !dateSelected && (
                    <Text style={{top: 3, color: 'red', top: -1}}>*</Text>
                  )}
                </View>
                    ...
                    <TouchableOpacity
                      ...
                      {!showBs && (
                        <Text
                          style={[
                            styles.listText,
                            {marginLeft: 10, color: colors.Neutral_01},
                          ]}>
                          {t('selectDate')}
                        </Text>
                      )}
            ...
            <ScrollView
              ...
              <View style={{width: '90%'}}>
                <View style={[styles.heading, {marginTop: 20}]}>
                  ...
                  <Text style={[Typography.text_paragraph_1, styles.editText]}>
                ...
                <View style={styles.taxContainer}>
                  <Text style={[Typography.text_CTA1, {color: colors.black}]}>
                    {t('pay') + ':'}
                  </Text>
                    ...
                    return (
                      <View key={index} style={styles.taxContainer_C1}>
                        <Text
                          ...
                          {key.name + ' ' + key.percentage + '%'}
                        </Text>
                        <Text
                          style={[Typography.text_CTA1, {color: colors.black}]}>
                          {'€' +
                            Number((totalPrice / 100) * key.percentage).toFixed(
                              1,
                            )}
                        </Text>
                      </View>
          ...
          {isJobCreate && (
            <View style={{width: '90%'}}>
              ...
              {selectedCategories === CleaningAndHygineService && (
                <>
                  <View style={[styles.heading, {marginTop: 20}]}>
                    ...
                    <Text
                      style={[Typography.text_paragraph_1, styles.editText]}>
                      {roomsize}
                    </Text>
                  </View>
              ...
              <View style={styles.taxContainer}>
                ...
                <View style={styles.taxContainer_C1}>
                  <Text
                    style={[Typography.text_CTA1, {color: colors.Neutral_01}]}>
                    {t('amount')}
                  </Text>
                  <Text style={[Typography.text_CTA1, {color: colors.black}]}>
                    {'€' + totalPrice}
