  ...
  return (
    <View style={styles.container}>
          ...
          <View style={styles.inputContiner}>
            ...
            <TextInput
              ...
              placeholderTextColor={
                theme === 'dark' ? colors.white : colors.Neutral_01
              }
            />
          </View>
        </View>
      ...
      <ScrollView
        ...
        {user.role !== 'user' && (
          <View style={styles.buttonContainer}>
            <CustomTabs
              ...
              setselectedState={setselectedTab}
              title={t('myjobs')}
            />
            <CustomTabs
              selectedState={selectedTab}
        ...
        {/* all ads Tab */}
        {(selectedTab === t('services') ||
          (user.role === 'provider'
            ? selectedTab === t('myjobs')
            : selectedTab !== t('myjobs'))) && (
          <>
              ...
              <View key={key} style={{width: '95%', alignItems: 'flex-start'}}>
                <View style={styles.subCatTextContainer}>
                  <Text
                    style={[
                      Typography.text_paragraph_1,
                      {fontWeight: 'bold', color: colors.black, marginTop: 20},
                    ]}>
                    {key}
                  </Text>
                  <TouchableOpacity
