          ...
          <View style={styles.list}>
            ...
            <View style={styles.list_C1}>
              <View
                ...
                <Text
                  style={[Typography.text_paragraph_1, {color: colors.black}]}>
                  Notification Received
                </Text>
                <Text
                  style={[Typography.text_paragraph, {color: colors.black}]}>
                  Today | 09:24 AM
                </Text>
              </View>
              <View style={styles.newButton}>
                <Text
                  style={[Typography.text_paragraph, {color: colors.white}]}>
                  {t('new')}
                </Text>
              </View>
            </View>
